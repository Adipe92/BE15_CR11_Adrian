...
$error = false;
$fname = $lname = $email = $date_of_birth = $pass = $user_address = $phone_nb = $picture = '';
$fnameError = $lnameError = $emailError = $dateError = $passError = $user_addressError = $phone_nbError = $picError = '';
if (isset($_POST['btn-signup'])) {
    ...
    $phone_nb = strip_tags($phone_nb);
    $phone_nb = htmlspecialchars($phone_nb);
    ...
    if(empty($phone_nb)) {
        $error = true;
        $phone_nb = "Please enter your phone number.";
    }
...
<head>
    ...
    <title>Pet Adoption - Registrate</title>
...
<div class="header-img">
      ...
      <form class="w-100" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off" enctype="multipart/form-data">
            ...
            <input class='form-control mb-3 w-100' type="date" name="date_of_birth" value="<?php echo $date_of_birth ?>" />
            <span class="text-danger"> <?php echo $dateError; ?> </span>

            <input class='form-control mb-3 w-100' type="file" name="picture">
            <span class="text-danger"> <?php echo $picError; ?> </span>
        
            <input type="password" name="pass" class="form-control mb-3" placeholder="Enter Password" maxlength="15" />
            <span class="text-danger"> <?php echo $passError; ?> </span>

            <input type="text" name="user_address" class="form-control mb-3" placeholder="Address" maxlength="15" />
            <span class="text-danger"> <?php echo $user_addressError; ?> </span>

            <input type="text" name="phone_nb" class="form-control mb-3" placeholder="Phone Number" />
            <span class="text-danger"> <?php echo $phone_nbError; ?> </span>

            <hr />
            <button type="submit" class="btn btn-block btn-secondary" name="btn-signup">Sign Up</button>
            <hr />
